...
import org.xtext.example.mydsl.mmlg.MmlgFactory;
 ...
 * @generated
 */
public class MmlgPackageImpl extends EPackageImpl implements MmlgPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.mmlg.MmlgPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MmlgPackageImpl()
  {
    super(eNS_URI, MmlgFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link MmlgPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MmlgPackage init()
  {
    if (isInited) return (MmlgPackage)EPackage.Registry.INSTANCE.getEPackage(MmlgPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMmlgPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MmlgPackageImpl theMmlgPackage = registeredMmlgPackage instanceof MmlgPackageImpl ? (MmlgPackageImpl)registeredMmlgPackage : new MmlgPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theMmlgPackage.createPackageContents();

    // Initialize created meta-data
    theMmlgPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMmlgPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MmlgPackage.eNS_URI, theMmlgPackage);
    return theMmlgPackage;
  }
   ...
   */
  @Override
  public MmlgFactory getMmlgFactory()
  {
    return (MmlgFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(svmEClass, org.xtext.example.mydsl.mmlg.SVM.class, "SVM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSVM_Gamma(), ecorePackage.getEString(), "gamma", null, 0, 1, org.xtext.example.mydsl.mmlg.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_C(), ecorePackage.getEString(), "C", null, 0, 1, org.xtext.example.mydsl.mmlg.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_Kernel(), this.getSVMKernel(), "kernel", null, 0, 1, org.xtext.example.mydsl.mmlg.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_Svmclassification(), this.getSVMClassification(), "svmclassification", null, 0, 1, org.xtext.example.mydsl.mmlg.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(dtEClass, org.xtext.example.mydsl.mmlg.DT.class, "DT", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDT_Max_depth(), ecorePackage.getEInt(), "max_depth", null, 0, 1, org.xtext.example.mydsl.mmlg.DT.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
