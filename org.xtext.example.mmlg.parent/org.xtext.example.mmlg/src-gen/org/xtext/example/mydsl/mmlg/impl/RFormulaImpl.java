 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.mmlg.impl.RFormulaImpl#getPredictive <em>Predictive</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.mmlg.impl.RFormulaImpl#getPredictors <em>Predictors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RFormulaImpl extends MinimalEObjectImpl.Container implements RFormula
{
  ...
  {
    return MmlgPackage.Literals.RFORMULA;
  }
  ...
  public NotificationChain basicSetPredictive(FormulaItem newPredictive, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MmlgPackage.RFORMULA__PREDICTIVE, oldPredictive, newPredictive);
  ...
  public void setPredictive(FormulaItem newPredictive)
  {
    if (newPredictive != predictive)
    {
      ...
      if (predictive != null)
        msgs = ((InternalEObject)predictive).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.RFORMULA__PREDICTIVE, null, msgs);
      if (newPredictive != null)
        msgs = ((InternalEObject)newPredictive).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.RFORMULA__PREDICTIVE, null, msgs);
      msgs = basicSetPredictive(newPredictive, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MmlgPackage.RFORMULA__PREDICTIVE, newPredictive, newPredictive));
  }
  ...
  public NotificationChain basicSetPredictors(XFormula newPredictors, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MmlgPackage.RFORMULA__PREDICTORS, oldPredictors, newPredictors);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPredictors(XFormula newPredictors)
  {
    if (newPredictors != predictors)
    {
      NotificationChain msgs = null;
      if (predictors != null)
        msgs = ((InternalEObject)predictors).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.RFORMULA__PREDICTORS, null, msgs);
      if (newPredictors != null)
        msgs = ((InternalEObject)newPredictors).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.RFORMULA__PREDICTORS, null, msgs);
      msgs = basicSetPredictors(newPredictors, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MmlgPackage.RFORMULA__PREDICTORS, newPredictors, newPredictors));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MmlgPackage.RFORMULA__PREDICTIVE:
        return basicSetPredictive(null, msgs);
      case MmlgPackage.RFORMULA__PREDICTORS:
