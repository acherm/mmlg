 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.mmlg.impl.MLChoiceAlgorithmImpl#getFramework <em>Framework</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.mmlg.impl.MLChoiceAlgorithmImpl#getAlgorithm <em>Algorithm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MLChoiceAlgorithmImpl extends MinimalEObjectImpl.Container implements MLChoiceAlgorithm
{
  ...
  {
    return MmlgPackage.Literals.ML_CHOICE_ALGORITHM;
  }
  ...
  public void setFramework(FrameworkLang newFramework)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MmlgPackage.ML_CHOICE_ALGORITHM__FRAMEWORK, oldFramework, framework));
  }
  ...
  public NotificationChain basicSetAlgorithm(MLAlgorithm newAlgorithm, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM, oldAlgorithm, newAlgorithm);
  ...
  public void setAlgorithm(MLAlgorithm newAlgorithm)
  {
    if (newAlgorithm != algorithm)
    {
      ...
      if (algorithm != null)
        msgs = ((InternalEObject)algorithm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM, null, msgs);
      if (newAlgorithm != null)
        msgs = ((InternalEObject)newAlgorithm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM, null, msgs);
      msgs = basicSetAlgorithm(newAlgorithm, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM, newAlgorithm, newAlgorithm));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MmlgPackage.ML_CHOICE_ALGORITHM__FRAMEWORK:
        return getFramework();
      case MmlgPackage.ML_CHOICE_ALGORITHM__ALGORITHM:
        return getAlgorithm();
    }
